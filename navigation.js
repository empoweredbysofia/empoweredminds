...
const pages={'programmes.html':'Programmes','schools.html':'For Schools','contact.html':'Find Support','about.html':'About Sofia','individuals.html':'For Individuals','communities.html':'Communities','speaking.html':'Speaking','commission.html':'Commission / Book'};
function activeFor(file){if(file==='index.html')return'home';if(file==='contact.html')return'support';if(file==='schools.html'||['girl-code-compass.html','adhd-understood.html','from-behaviour-to-understanding.html','my-adhd-and-me.html'].includes(file))return'schools';if(file==='about.html')return'about';if(file==='programmes.html'||details[file]||file==='individuals.html'||file==='communities.html')return'programmes';return''}
const active=activeFor(current);
const header=document.createElement('header');header.className='em-site-header';header.innerHTML='<div class="em-nav-wrap"><a class="em-brand" href="index.html" aria-label="EmpowerED Minds home">Empower<strong>ED</strong> Minds™<small>by Sofia</small></a><button class="em-menu-toggle" type="button" aria-label="Open menu" aria-expanded="false" aria-controls="em-main-nav">☰</button><nav class="em-main-nav" id="em-main-nav" aria-label="Main navigation"><a href="index.html" data-key="home">Home</a><a href="contact.html" data-key="support">Find Support</a><a href="programmes.html" data-key="programmes">Programmes</a><a href="schools.html" data-key="schools">For Schools</a><a href="about.html" data-key="about">About Sofia</a><a class="em-nav-cta" href="contact.html">Enquire / Book</a></nav></div>';
